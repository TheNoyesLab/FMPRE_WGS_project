...
# Load metadata file
SRA_metadata <- read.table("Pipeline_results/Salmonella_MS_geography/exported_trees/Salmonella_MS_metadata.csv",header = TRUE, fill = FALSE ,sep = ',',stringsAsFactors = TRUE)
# typeof(SRA_metadata)
# View(SRA_metadata)
# typeof(as.data.frame(SRA_metadata))

# Read in phylogenetic trees
lyve_tree <- read.tree(file = "Pipeline_results/Salmonella_MS_geography/exported_trees/lyveset_NJ.newick")
# kSNP3 tree.NJ.tre, tree.ML.tre, tree.core.tre, tree.parsimony.tre
ksnp_tree <- read.tree(file = "Pipeline_results/Salmonella_MS_geography/exported_trees/ksnp3_core_NJ.newick")
# Cfsan
cfsan_tree <- read.tree(file = "Pipeline_results/Salmonella_MS_geography/exported_trees/cfsan_NJ.newick")
# Enterobase
enterobase_tree <- read.tree(file = "Pipeline_results/Salmonella_MS_geography/exported_trees/lyveset_NJ.newick")
...
# png(filename = "Salmonella_MS_lyveset_tree.png", res = 300,width = 800, height = 800)
...
SRA_metadata <- SRA_metadata %>% mutate(Group = ifelse(SNP.cluster == "PDS000061489.22" , "Outbreak", "Other"))
...
plyve2
ggsave("Pipeline_results/Salmonella_MS_geography/lyve_tree_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
plyve2 <- plyve + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
plyve2
ggsave("Pipeline_results/Salmonella_MS_geography/lyve_tree_nolengths_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
pcfsan2 <- pcfsan + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
pcfsan2
ggsave("Pipeline_results/Salmonella_MS_geography/cfsan_tree_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
pcfsan2 <- pcfsan + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
pcfsan2
ggsave("Pipeline_results/Salmonella_MS_geography/cfsan_tree_nolengths_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
penterobase2 <- penterobase + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
penterobase2
ggsave("Pipeline_results/Salmonella_MS_geography/enterobase_tree_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
penterobase2 <- penterobase + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
penterobase2
ggsave("Pipeline_results/Salmonella_MS_geography/enterobase_tree_nolengths_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
pksnp2 <- pksnp + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
pksnp2
ggsave("Pipeline_results/Salmonella_MS_geography/ksnp_tree_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
pksnp2 <- pksnp + geom_tiplab(offset = .6, hjust = .5) +
  ...
  theme(legend.position = "right") + scale_size_continuous(range = c(3, 10))
pksnp2
ggsave("Pipeline_results/Salmonella_MS_geography/ksnp_tree_nolengths_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
pfacet_tree
ggsave("Pipeline_results/Salmonella_MS_geography/combined_trees_wblengths_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()

# no branch lengths
pfacet_tree2 <- ggtree(combined_cleaned_trees,branch.length='none') + facet_wrap( ~.id, scale="free") + theme_tree2()
pfacet_tree2
ggsave("Pipeline_results/Salmonella_MS_geography/combined_trees_nolengths_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
...
pdense_tree
ggsave("Pipeline_results/Salmonella_MS_geography/combined_trees_dense_tree_Salmonella_MS.png", width = 50, height = 80, units = "cm")
dev.off()
