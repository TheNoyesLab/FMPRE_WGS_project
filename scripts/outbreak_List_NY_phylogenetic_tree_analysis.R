...
lyve_tree <- read.tree(file = "Pipeline_results/Listeria_NY_and_outbreak_geography/exported_trees/lyveset_NJ.newick")
# kSNP3 tree.NJ.tre, tree.ML.tre, tree.core.tre, tree.parsimony.tre
ksnp_tree <- read.tree(file = "Pipeline_results/Listeria_NY_and_outbreak_geography/exported_trees/ksnp3_NJ.newick")
# Cfsan
cfsan_tree <- read.tree(file = "Pipeline_results/Listeria_NY_and_outbreak_geography/exported_trees/cfsan_NJ.newick")
# Enterobase
...
plyve2
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/lyve_tree_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
...
plyve2 <- plyve  +
  ...
  theme(legend.position = "right",
        ...
        axis.text.x = element_blank()) 
plyve2
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/lyve_tree_nolengths_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
...
pcfsan2 <- pcfsan +
  ...
  theme(legend.position = "right",
        ...
        axis.text.x = element_blank()) 
pcfsan2
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/cfsan_tree_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
...
pcfsan2 <- pcfsan  +
  ...
  theme(legend.position = "right",
        ...
        axis.text.x = element_blank()) 
pcfsan2
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/cfsan_tree_nolengths_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
...
pksnp2 <- pksnp  +
  ...
  theme(legend.position = "right",
        ...
        axis.text.x = element_blank()) 
pksnp2
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/ksnp_tree_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
...
pfacet_tree <- ggtree(combined_cleaned_trees) + facet_wrap( ~.id, scale="free") + theme_tree2() +
  theme(legend.title=element_text(size=10), 
        legend.text=element_text(size=9))
pfacet_tree
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/combined_trees_wblengths_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()

# no branch lengths
pfacet_tree2 <- ggtree(combined_cleaned_trees,branch.length='none') + facet_wrap( ~.id, scale="free") + theme_tree2()
pfacet_tree2
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/combined_trees_nolengths_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
...
pdense_tree
ggsave("Pipeline_results/Listeria_NY_and_outbreak_geography/combined_trees_dense_tree_Listeria_NY_and_outbreak.png", width = 50, height = 80, units = "cm")
dev.off()
