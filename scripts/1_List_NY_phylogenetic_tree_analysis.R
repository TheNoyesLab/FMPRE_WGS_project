...
# Load metadata file
SRA_metadata <- read.table("Pipeline_results/Old_results/Listeria_NewYork_geography/exported_trees/clean_Listeria_NY_metadata.csv",header = TRUE, fill = FALSE, sep = ',',stringsAsFactors = TRUE)
SRA_metadata
# View(SRA_metadata)
...
lyve_tree <- read.tree(file = "Pipeline_results/Old_results/Listeria_NewYork_geography/exported_trees/lyveset_NJ.newick")
# kSNP3 tree.NJ.tre, tree.ML.tre, tree.core.tre, tree.parsimony.tre
ksnp_tree <- read.tree(file = "Pipeline_results/Old_results/Listeria_NewYork_geography/exported_trees/ksnp3_NJ.newick")
# Cfsan
cfsan_tree <- read.tree(file = "Pipeline_results/Old_results/Listeria_NewYork_geography/exported_trees/cfsan_NJ.newick")
# Enterobase
enterobase_tree <- read.tree(file = "Pipeline_results/Old_results/Listeria_NewYork_geography/exported_trees/enterobase_NJ.newick")
...
plyve2
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/lyve_tree_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()
...
pcfsan2
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/cfsan_tree_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()
...
penterobase2
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/enterobase_tree_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()
...
pksnp2
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/ksnp_tree_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()
...
pfacet_tree
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/combined_trees_wblengths_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()

# no branch lengths
pfacet_tree2 <- ggtree(combined_cleaned_trees,branch.length='none') + facet_wrap( ~.id, scale="free") + theme_tree2()
pfacet_tree2
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/combined_trees_nolengths_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()
...
pdense_tree
ggsave("Pipeline_results/Old_results/Listeria_NewYork_geography/combined_trees_dense_tree_List_NY.png", width = 50, height = 80, units = "cm")
dev.off()
